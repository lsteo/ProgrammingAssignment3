...
## merge the data in the above 3 data.frame into 1 data.frame - test.data,
...
## merge the data in the above 3 data.frame into 1 data.frame - train.data,
...
## replace mean.std.data[, 2] containing labels with its corresponding descriptive activity names in activity_labels[, 2] 
...
## export tidy.data to a txt file tidy_data.txt without the row names
